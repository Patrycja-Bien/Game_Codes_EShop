...
public class UserService : IUserService
{
    ...
    public async Task<User.Domain.Models.User> AddUserAsync(User.Domain.Models.User user)
    {
        ...
        //string key = $"User:{result.Id}";
        //await _redisDb.StringSetAsync(key, JsonSerializer.Serialize(result), TimeSpan.FromHours(24));
        return result;
    }

    public async Task<User.Domain.Models.User?> GetFullUserAsync(int userId)
    {
