...
public class Program
{
    private static async Task Main(string[] args)
    {
        ...
        // Baza danych
        builder.Services.AddDbContext<ShoppingCart.Infrastructure.Repositories.DataContext>(options =>
        ...
        {
            var db = scope.ServiceProvider.GetRequiredService<ShoppingCart.Infrastructure.Repositories.DataContext>();
